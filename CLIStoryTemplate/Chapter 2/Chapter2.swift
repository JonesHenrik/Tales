...
func chapterTwo() {
    ...
    if let name = name {
        ...
        """)
            ...
            print("""
        3. Learning the Ropes: Literally and figuratively, you become more familiar with climbing techniques and safety procedures. Learning to tie knots, belaying, and using equipment becomes second nature.
